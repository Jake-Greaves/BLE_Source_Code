...
#include "user_periph_setup.h" //pin and port definitions
#include "spi_sps.h"       // spi definition
#include "reg_uart.h"   // uart register TODO: find SPI register
#include "hcic_eif.h"   // hci uart definition TODO: replace with spi_hci
#include "global_io.h"
...
{
    uint8_t readData = 0;        //spi receive data will be read into this variable
